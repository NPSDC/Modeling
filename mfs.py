...
def eval_membership_function_pi3k(pi3k_values, positive_change_pi3k, negative_change_pi3k):
	...
	return (pi3k_low, pi3k_high, positive_change_pi3k_low, positive_change_pi3k_high, negative_change_pi3k_low, negative_change_pi3k_high)
...
def eval_membership_function_erk(erk_values, positive_change_erk, negative_change_erk):
	...
	return (erk_low, erk_high, positive_change_erk_low, positive_change_erk_high, negative_change_erk_low, negative_change_erk_high)
